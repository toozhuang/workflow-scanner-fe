        ...
        <div style={{
            ...
            {!display &&
                <Descriptions
                    ...
                    <Descriptions.Item label="文件名:">{inPros.file.fileInfo.name}</Descriptions.Item>
                    <Descriptions.Item label="文件类型">{inPros.file.fileInfo.type}</Descriptions.Item>
                    <Descriptions.Item span={2} label="大小">{getFilesize(inPros.file.fileInfo.size)}</Descriptions.Item>

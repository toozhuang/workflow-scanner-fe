...
class Axios extends Abstract{
    ...
    getRequest({ baseURL, headers, url, data, params, responseType,withCredentials }: AxiosRequest) {
        return this.apiAxios({ baseURL, headers, method: 'GET', url, data, params, responseType,withCredentials });
    }
